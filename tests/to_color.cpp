...
#include <termcolor2/to_color.hpp>
...
{
    static_assert((termcolor2::to_gray<char, 3, 'f', 'o', 'o'>()) == termcolor2::gray + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_red<char, 3, 'f', 'o', 'o'>()) == termcolor2::red + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_green<char, 3, 'f', 'o', 'o'>()) == termcolor2::green + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_yellow<char, 3, 'f', 'o', 'o'>()) == termcolor2::yellow + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_blue<char, 3, 'f', 'o', 'o'>()) == termcolor2::blue + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_magenta<char, 3, 'f', 'o', 'o'>()) == termcolor2::magenta + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_cyan<char, 3, 'f', 'o', 'o'>()) == termcolor2::cyan + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_white<char, 3, 'f', 'o', 'o'>()) == termcolor2::white + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_gray<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::gray_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_red<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::red_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_green<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::green_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_yellow<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::yellow_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_blue<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::blue_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_magenta<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::magenta_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_cyan<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::cyan_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_white<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::white_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_gray<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::gray_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_red<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::red_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_green<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::green_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_yellow<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::yellow_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_blue<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::blue_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_magenta<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::magenta_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_cyan<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::cyan_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_white<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::white_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_gray<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::gray_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_red<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::red_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_green<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::green_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_yellow<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::yellow_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_blue<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::blue_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_magenta<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::magenta_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_cyan<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::cyan_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_white<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::white_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
...
{
    static_assert((termcolor2::to_on_gray<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_gray + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_red<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_red + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_green<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_green + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_yellow<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_yellow + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_blue<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_blue + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_magenta<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_magenta + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_cyan<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_cyan + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_white<char, 3, 'f', 'o', 'o'>()) == termcolor2::on_white + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_on_gray<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_gray_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_red<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_red_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_green<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_green_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_yellow<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_yellow_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_blue<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_blue_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_magenta<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_magenta_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_cyan<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_cyan_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_white<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_white_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_on_gray<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_gray_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_red<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_red_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_green<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_green_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_yellow<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_yellow_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_blue<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_blue_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_magenta<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_magenta_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_cyan<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_cyan_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_white<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_white_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_on_gray<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_gray_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_red<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_red_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_green<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_green_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_yellow<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_yellow_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_blue<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_blue_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_magenta<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_magenta_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_cyan<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_cyan_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_on_white<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::on_white_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
...
{
    static_assert((termcolor2::to_bold<char, 3, 'f', 'o', 'o'>()) == termcolor2::bold + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_dark<char, 3, 'f', 'o', 'o'>()) == termcolor2::dark + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_underline<char, 3, 'f', 'o', 'o'>()) == termcolor2::underline + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_blink<char, 3, 'f', 'o', 'o'>()) == termcolor2::blink + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_reverse<char, 3, 'f', 'o', 'o'>()) == termcolor2::reverse + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_concealed<char, 3, 'f', 'o', 'o'>()) == termcolor2::concealed + "foo" + termcolor2::reset, "");
    ...
    static_assert((termcolor2::to_bold<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::bold_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_dark<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::dark_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_underline<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::underline_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_blink<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::blink_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_reverse<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::reverse_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_concealed<wchar_t, 3, 'f', 'o', 'o'>()) == termcolor2::concealed_v<wchar_t>() + L"foo" + termcolor2::reset_v<wchar_t>(), "");
    ...
    static_assert((termcolor2::to_bold<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::bold_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_dark<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::dark_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_underline<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::underline_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_blink<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::blink_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_reverse<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::reverse_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_concealed<char16_t, 3, 'f', 'o', 'o'>()) == termcolor2::concealed_v<char16_t>() + u"foo" + termcolor2::reset_v<char16_t>(), "");
    ...
    static_assert((termcolor2::to_bold<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::bold_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_dark<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::dark_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_underline<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::underline_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_blink<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::blink_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_reverse<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::reverse_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
    ...
    static_assert((termcolor2::to_concealed<char32_t, 3, 'f', 'o', 'o'>()) == termcolor2::concealed_v<char32_t>() + U"foo" + termcolor2::reset_v<char32_t>(), "");
